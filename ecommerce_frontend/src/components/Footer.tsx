...
export const PrivacyPolicy = () => {
  return (
    <div className="privacy">
      ...
      <p>
        Dipan operates the ecommerce.com website, which provides the
        SERVICE.
      </p>
      ...
      <p>
        ...
        decided to use our Service, the Ecommerce website.
      </p>
      ...
      <p>
        ...
        Terms and Conditions, which is accessible at ecommerce.com, unless
